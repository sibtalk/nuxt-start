...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CEw-N94A.mjs').then((m) => m.default || m)
  },
  {
    name: "start-config",
    path: "/start/config",
    component: () => import('./config--NkYTClv.mjs').then((m) => m.default || m)
  },
  {
    name: "start",
    path: "/start",
    component: () => import('./index-DJU23oED.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-4A4eVgvz.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CwM0kD5S.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Cp3c-U1h.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useSeoMeta as a, appConfig as b, useNuxtApp as c, useState as d, entry$1 as default, useRouter as e, useAppConfig as f, get as g, navigateTo as h, useRuntimeConfig as i, asyncDataDefaults as j, createError as k, mergeConfig as m, nuxtLinkDefaults as n, omit as o, resolveRouteObject as r, useHead as u };
