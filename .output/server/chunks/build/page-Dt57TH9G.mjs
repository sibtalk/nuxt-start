import { useAttrs, computed, toValue, defineComponent, toRef, useSSRContext, getCurrentInstance, provide, inject, ref, watch, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { f as useAppConfig, m as mergeConfig, g as get, o as omit, b as appConfig, _ as _export_sfc } from './server.mjs';
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { _ as __nuxt_component_0$3 } from './nuxt-link-CeQgT4A4.mjs';
import __nuxt_component_0$4 from './index-4A4eVgvz.mjs';
...
const _sfc_main$6 = defineComponent({
  ...
  setup(props) {
    const { ui, attrs } = useUI("container", toRef(props, "ui"), config$3);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrap" }, _attrs))} data-v-09fe8d36><ul data-v-09fe8d36><li data-v-09fe8d36>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/start" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
  ...
  _push(`</li><li data-v-09fe8d36>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/start/config" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_UAlert, {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/body/rightMenu/page.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-09fe8d36"]]);

export { __nuxt_component_0$2 as _, __nuxt_component_4 as a, __nuxt_component_6 as b, useInjectButtonGroup as c, __nuxt_component_3 as d, useUI as u };
//# sourceMappingURL=page-Dt57TH9G.mjs.map
